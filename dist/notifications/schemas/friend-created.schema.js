...
exports.friendCreatedSchema = void 0;
const z = __importStar(require("zod"));
const type_db_1 = require("../../type.db");
exports.friendCreatedSchema = z.object({
    id: z.number().int().describe('The ID of the friend record'),
    type: z.literal(type_db_1.NotificationTypeEnum.friend_created).describe('Type of notification'),
    friend: z.object({
...
//# sourceMappingURL=friend-created.schema.js.map
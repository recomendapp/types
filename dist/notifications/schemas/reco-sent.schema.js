...
exports.recoSentSchema = void 0;
const z = __importStar(require("zod"));
const type_db_1 = require("../../type.db");
exports.recoSentSchema = z.object({
    id: z.number().int().describe('The ID of the reco'),
    type: z.literal(type_db_1.NotificationTypeEnum.reco_sent).describe('Type of notification'),
    sender: z.object({
...
//# sourceMappingURL=reco-sent.schema.js.map
...
exports.followerAcceptedSchema = void 0;
const z = __importStar(require("zod"));
const type_db_1 = require("../../type.db");
exports.followerAcceptedSchema = z.object({
    id: z.number().int().describe('The ID of the follower record'),
    type: z.literal(type_db_1.NotificationTypeEnum.follower_accepted).describe('Type of notification'),
    sender: z.object({
...
//# sourceMappingURL=follower-accepted.schema.js.map